...
class DAC7678
{
    public:
        ...
        uint8_t getAddressVar() { return this.address; }
        TwoWire& getWireObject() {return this->wire; }
        UpdateMode getUpdateModeVar() { return this.update_mode; }
        ReferenceMode getReferenceModeVar() { return this.ref_mode; }
